...
const Hero = ({ onCtaClick }: { onCtaClick: (e?: React.MouseEvent) => void }) => (
  <section className="relative overflow-hidden bg-bg-primary pt-32 pb-28 md:pt-44 md:pb-36">
    ...
    <div
      className="pointer-events-none absolute left-1/2 -translate-x-1/2 top-24 md:top-32 font-mono-num text-gold-deep/60"
      style={{ fontSize: 9, letterSpacing: '0.4em' }}
    >
      N 35°40′ · E 139°41′ · VAULT 001
    </div>
    <div
      className="pointer-events-none absolute left-1/2 -translate-x-1/2 bottom-10 md:bottom-14 font-mono-num text-text-secondary/60"
      style={{ fontSize: 9, letterSpacing: '0.4em' }}
    >
    ...
    <div className="relative mx-auto max-w-[920px] px-6 text-center hero-stagger">
      ...
      <h1
        className="font-display text-text-primary mt-8"
      ...
      <div className="mx-auto max-w-[1180px] px-6 md:px-10 mb-10 flex items-end justify-between gap-6">
        <div>
          ...
          <h2
            ...
            style={{ fontSize: 'clamp(22px, 3vw, 28px)', lineHeight: 1.25 }}
          >
            ジャンルを問わず、高価格帯商材すべてに対応。
          </h2>
        </div>
        <div
          className="hidden md:block font-mono-num text-text-secondary"
          ...
          {loop.map((it, i) => (
            ...
            >
              ...
              <figcaption className="absolute left-0 right-0 bottom-0 flex items-center justify-between px-4 py-3 bg-gradient-to-t from-bg-primary via-bg-primary/80 to-transparent">
                <span className="text-text-primary font-display" style={{ fontSize: 15 }}>
                  {it.label}
                </span>
                <span className="font-mono-num text-gold-deep" style={{ fontSize: 9, letterSpacing: '0.2em' }}>
                  {it.cat}
                </span>
              </figcaption>
            </figure>
        ...
        <ul className="mt-8 space-y-5">
          {[
            ...
            <li key={t} className="flex gap-4 text-text-secondary" style={{ fontSize: 13, lineHeight: 2 }}>
              <span className="text-risk-accent select-none" aria-hidden>
                ×
              </span>
              <span>{t}</span>
            </li>
      ...
      <div className="reveal-right">
        ...
        <div className="mt-8 flex flex-wrap gap-2">
          {['既存サービス A:非対応', '既存サービス B:非対応', 'RentRich:✓ 標準搭載'].map((b) => (
            <span
              key={b}
              className="font-mono-num bg-gold-muted text-gold-light"
    ...
    <section className="bg-bg-primary py-24 md:py-32">
      <div className="mx-auto max-w-[1180px] px-6 md:px-10">
        <div className="reveal text-center">
          ...
          <h2
            className="font-display text-text-primary mt-6"
            style={{ fontSize: 'clamp(28px, 4vw, 36px)', lineHeight: 1.2 }}
          >
          ...
          <table className="w-full min-w-[720px] border border-border border-collapse">
            <thead>
              <tr className="bg-bg-surface">
                <th
                  className="text-left p-4 label-eyebrow text-text-secondary"
                  style={{ letterSpacing: '0.2em', fontSize: 10 }}
                >
                  比較項目
                </th>
                <th className="p-4 label-eyebrow text-text-secondary" style={{ letterSpacing: '0.2em', fontSize: 10 }}>
                  レンタルASP A
                </th>
                <th className="p-4 label-eyebrow text-text-secondary" style={{ letterSpacing: '0.2em', fontSize: 10 }}>
                  レンタルASP B
                ...
                <th
                  ...
                  style={{
                    borderLeft: '1px solid hsl(var(--gold-deep))',
                    borderRight: '1px solid hsl(var(--gold-deep))',
                  }}
                >
                  <div className="label-eyebrow text-text-primary" style={{ letterSpacing: '0.2em', fontSize: 10 }}>
                    RentRich
                  </div>
                  <div
                    className="mt-2 inline-block bg-gold-muted text-gold-light font-sans-ui"
                    style={{ fontSize: 9, padding: '3px 8px', letterSpacing: '0.1em' }}
                  >
                    ▲ 推奨
                  </div>
                </th>
            ...
            <tbody>
              {rows.map(([label, a, b, r]) => (
                <tr key={label} className="border-t border-border">
                  <td className="p-4 text-text-primary" style={{ fontSize: 13 }}>
                    {label}
                  </td>
                    ...
                    {label === '決済手数料' ? (
                      ...
                      <span className="inline-flex flex-col items-center gap-1">
                        <span className="inline-flex items-baseline gap-2">
                          ...
                          <span className="font-mono-num text-gold-deep" style={{ fontSize: 13 }}>
                            0円
                          </span>
                        </span>
                        <span
  ...
  const cards: Array<{ n: string; h: string; d: string; img: string; alt: string }> = [
    {
      n: '01',
      h: '最短1日でショップ開設',
      d: '扱う商材を問わず、テンプレートを選んで商品を登録するだけ。技術知識は不要。システム開発費300〜500万円を削減できます。',
      img: featureStorefront.src,
      alt: 'ダークテーマのレンタルECストアフロント例',
    },
    {
      n: '02',
      h: '決済・在庫・予約をワンストップ管理',
      d: '複雑なレンタル業務を一つの管理画面に集約。顧客管理・レンタル延長・クーポン発行まで対応。運営コストを大幅に削減できます。',
      img: featureDashboard.src,
      alt: 'RentRich管理ダッシュボードのイメージ',
    },
    {
      n: '03',
      h: 'ブランドらしいショップデザイン',
      d: 'カラー・フォント・ロゴを自由にカスタマイズ。あなたのビジネスの世界観をそのまま表現できます。',
      img: featureBrand.src,
      alt: 'ブランドアイデンティティ表現の例',
    },
  ];
        ...
        <div className="mt-16 grid grid-cols-1 gap-10 md:grid-cols-3 md:gap-8">
          {cards.map((c, i) => (
            <div key={c.n} className="reveal" data-reveal-delay={`${i * 0.12}s`}>
              ...
              <div
                className="relative mt-6 overflow-hidden border border-border-gold bg-bg-surface"
              ...
              <div className="pt-4">
                <div className="font-mono-num text-gold-deep" style={{ fontSize: 11, letterSpacing: '0.3em' }}>
                  {c.n}
                </div>
                <h3 className="font-display text-text-primary mt-5" style={{ fontSize: 20, lineHeight: 1.35 }}>
                  {c.h}
                </h3>
                <p className="mt-4 text-text-secondary" style={{ fontSize: 13, lineHeight: 1.85 }}>
                  {c.d}
                </p>
              </div>
            </div>
  ...
  return (
    <section id="register" className="relative overflow-hidden bg-bg-secondary py-28 md:py-36 border-t border-border">
      ...
      <div className="relative mx-auto max-w-[560px] px-6 text-center">
        ...
        <h2
          className="reveal font-display text-text-primary mt-8"
        ...
        <p className="mt-5 text-text-secondary" style={{ fontSize: 10 }}>
          <span className="text-gold-deep">✓</span> 無料・登録のみ &nbsp; <span className="text-gold-deep">✓</span>{' '}
          サービス提供後、即ご連絡します
        </p>
      </div>
    </section>
  ...
  <footer className="border-t border-border py-14" style={{ backgroundColor: '#050505' }}>
    <div className="mx-auto max-w-[1180px] px-6 md:px-10">
      <div className="flex flex-col gap-10 md:flex-row md:items-start md:justify-between">
        <div>
          <p className="font-display text-gold-deep" style={{ fontSize: 18, letterSpacing: '0.15em' }}>
            RentRich
          </p>
          <p className="mt-3 text-text-secondary" style={{ fontSize: 12, lineHeight: 1.8 }}>
            高価格帯商材向けレンタルECプラットフォーム
            <br />
            運営：Shareris株式会社
          </p>
        </div>
        ...
        <div className="flex flex-col gap-2">
          <p className="label-eyebrow text-text-secondary mb-1" style={{ fontSize: 9 }}>
            COMPANY
          </p>
          <a
